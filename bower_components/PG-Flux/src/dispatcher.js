 ...
 *
 *   dispatcher is always available
 *
 ...
 * `FlightPriceStore`.
 */
define(['invariant'], function(invariant) {
 ...
 * @internal
 */
Dispatcher.prototype.dispatcherInvokeCallback=function(id) {
 ...
 * @internal
 */
Dispatcher.prototype.dispatcherStartDispatching=function(payload) {
  for (var id in this.dispatcherCallbacks) {
 ...
 * @internal
 */
Dispatcher.prototype.dispatcherStopDispatching=function() {
  this.dispatcherPendingPayload = null;
  this.dispatcherIsDispatching = false;
};
/**
...
* @internal
*/
Dispatcher.prototype._handler=function(source, action) {
  var payload = {
    source: source,
    action: action
  };
...
*/
Dispatcher.prototype.dispatchRouteAction = function(action) {
...
*/
Dispatcher.prototype.dispatchViewAction = function(action) {
  this._handler(this.constants.VIEW_SOURCE, action);
};

Dispatcher.prototype.constants = {
